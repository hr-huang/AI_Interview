...
def _client() -> TestClient:
    app = FastAPI()
    # InterviewService construction requires a repository even though these
    # route-contract tests patch start/answer before either method uses it.
    app.state.container = SimpleNamespace(repository=object())
